...
export const AI_POLICY_VERSIONS = [
  {
    ...
    date: "August 18, 2026",
    paragraphs: [
    `As artists, we have held steadfast that the craft of making the art is crucial to its quality. Concurrently, the most essential bargaining power of the working class is labor, and automation has the power to render the less-powerful powerless. We believe the cheery “${EXT("https://en.wikipedia.org/wiki/Artificial_intelligence", "AI")} is just a tool!” argument is a slippery slope to the complete automation of humanity, because a tool used without care quickly becomes a weapon.`,
    `Given these initial perspectives, and factoring in how content ${EXT("https://en.wikipedia.org/wiki/Generative_AI", "generated by AI")} is increasingly less discernible from human-made content, Capital P wants to set a precedent for how media companies disclose their policy for AI usage. We believe a company owes it to their clients and audience to be fully transparent with how they use AI. Additionally, this statement will remain viewable and unedited if we decide to create a new policy, for accountability purposes. Newer terms and acronyms will be hyperlinked for those who are less familiar.`,
    ...
    `Entirely unaltered AI-generated text will <b>not</b> be copied into any projects or emailed/texted to clients on behalf of Capital P.`,
    `Capital P is of the opinion that confidential information, or even basic client information, <b>cannot</b> be considered protected if it is uploaded to an LLM. Therefore, Capital P will manually anonymize any client assets that could be uploaded to online LLMs–– to be used only in circumstances where all human/manual resources have been exhausted or are not applicable. The use of local LLMs (including local ${EXT("https://en.wikipedia.org/wiki/Natural_language_generation", "NLG")} tools) are permitted, because the information fed to them cannot reach a third party connected to the internet.`,
    `It is a company’s responsibility to provide transparency for dangerous technologies, so if there are any areas you feel are omitted from this draft of the policy, send us an email.`,
    ],
